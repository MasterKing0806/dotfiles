...
alias reboot='hyprshutdown -t "Bye Bye" --post-cmd "reboot"'

alias rwaybar='waybar & disown'

alias shut='hyprshutdown -t "Bye Bye" --post-cmd "shutdown -h now"'
...
alias vpn='sudo systemctl restart NetworkManager'
